...
INSERT INTO atencion (fecha_atencion, descripcion, id_mascota, tipo, id_profesional)
VALUES (
  '2026-03-09',
  'Control anual y vacunas',
  currval(pg_get_serial_sequence('mascota','id_mascota')),
  'Perro',
  1
);
